...
export function runBenchmark(s: StoreClient<Song>) {
  ...
  console.time("Searching for all songs by 'The Rolling Stones' that are 3m long...")
  const stones270 = s.retrieve({
    title: undefined,
    artist: "The Rolling Stones",
    runtime: 270,
  })
  console.timeEnd("Searching for all songs by 'The Rolling Stones' that are 3m long...")
